  ...
  return (
    <div className="max-w-sm mx-auto bg-white border border-black/5 rounded-2xl p-6 shadow-sm">
      <div className="space-y-1 text-center mb-4">
        ...
        <p className="text-xs text-gray-600">Log in to manage your events and chat.</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <button className="rounded-full bg-blue-600 text-white px-5 py-2 w-full shadow-sm hover:bg-blue-700" onClick={submit}>Login</button>
      </div>
      <div className="text-xs text-center mt-4">No account? <Link to="/register" className="text-blue-600">Create one</Link></div>
    </div>
  );
}
